...
<!--Not found-->
<section class="not-found page-background">
	<div class="not-found__top page-top">
		<!--Page title-->
		<div class="page-title">
			<h2 class="page-top__title">
				Вибачте, але сторінка не знайдена
			</h2>
		</div>
		<div class="page-top__description">
			Неправильно набраний адресу або такої сторінки на сайті не існує.
			Перейдіть на головну сторінку або скористайтеся меню.
		</div>
		<!--End page title-->
	</div>
</section>
